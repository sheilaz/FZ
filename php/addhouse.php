...
$sql = "
	INSERT INTO house (building, district, style, balcony, direction, pay, price, area, bn, fn, rn)
	VALUES ('{$building}', '{$_POST['district']}', '{$_POST['style']}', '{$_POST['balcony']}', '{$_POST['direction']}', '{$_POST['pay']}', '{$_POST['price']}', '{$_POST['area']}', '{$_POST['place01']}', '{$_POST['place02']}', '{$_POST['place03']}')
